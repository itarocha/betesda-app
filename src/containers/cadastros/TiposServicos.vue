<template>
  <div>
    ...
    <el-container v-if="state == 'browse'">
      <el-header>
        <el-tooltip content="Incluir novo Tipo de Serviço" placement="bottom" :open-delay="toolTipDelay">
        ...
        <el-row type="flex" justify="center" align="middle">
          <el-col :sm="24" :md="24" :lg="24">
            <el-table
              ...
              <el-table-column prop="ativo" label="Ativo?" width="100" :formatter="fmtSimNao"></el-table-column>
